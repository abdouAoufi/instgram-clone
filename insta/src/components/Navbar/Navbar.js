...
const Navbar = ({ user }) => {
  ...
  return (
    <div>
      {/* {heder} */}
      <div className=" box-border px-4 flex justify-between items-center py-3 border border-gray-200 bg-white lg:px-32">
        ...
        <div className="hidden   lg:flex-1 lg:block">
          <div
            className={`justify-center flex p-0.5 items-center border overflow-hidden w-56 border border-gray-200 rounded ${
              !searchIconMove ? "pl-24" : null
            }`}
          >
            <SearchIcon style={{ fontSize: 17 }} color="disabled" />
            <input
