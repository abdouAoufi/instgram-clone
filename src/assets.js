...
export const textWelcome =
  " Welcome please note this is just a clone instagram version   try to upload a picture to test our app , feel free to use a fake data  , If you like it give us a feedback ";
